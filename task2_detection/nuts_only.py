...
from data_loader.data_loader_nuts import ClassDataset
...
class Trainer:
    ...
    def _setup_logging(self):
        self.logger = logging.getLogger('hazelnut_trainer')
        ...
        log_file = self.ckpt_dir / f"{self.timestamp}_hazelnut_logging.log"
        csv_file_name = f"{self.timestamp}_hazelnut_pred.csv"
    ...
    def train(self, num_epochs: int = 10):
        self.logger.info("=" * 60)
        self.logger.info("开始训练 hazelnut good/bad 分类模型")
...
def main():
    ...
    print("=" * 60)
    print("开始训练 hazelnut good/bad 分类模型")
    print("=" * 60)
